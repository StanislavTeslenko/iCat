...
//  iCat
//
//  Created by Stanislav Teslenko on 04.05.2020.
...
final class ImageScrollView: UIScrollView {
    ...
    fileprivate var imageZoomView: UIImageView!
    
    fileprivate lazy var zoomingTap: UITapGestureRecognizer = {
...
extension ImageScrollView {
    ...
    fileprivate func configure(imageSize: CGSize) {
    ...
    fileprivate func setCurrentZoomScale() {
...
extension ImageScrollView {
    ...
    @objc fileprivate func handleZoomingTap(sender: UITapGestureRecognizer) {
